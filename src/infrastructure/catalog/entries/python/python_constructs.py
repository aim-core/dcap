...
_C_CWE78   = _cite("CWE-78", "OS Command Injection", "2024-02-29", "https://cwe.mitre.org/data/definitions/78.html")
_C_OS_SYSTEM = _cite("PYTHON-OS", "os.system() Docs", "2024-01-01", "https://docs.python.org/3/library/os.html#os.system")
_C_CWE502  = _cite("CWE-502", "Deserialization of Untrusted Data", "2024-02-29", "https://cwe.mitre.org/data/definitions/502.html")
_C_YAML     = _cite("PYTHON-YAML", "PyYAML security", "2024-01-01", "https://pyyaml.org/wiki/PyYAMLDocumentation")
_C_CWE489  = _cite("CWE-489", "Active Debug Code", "2024-02-29", "https://cwe.mitre.org/data/definitions/489.html")
_C_FLASK    = _cite("FLASK", "Flask debug mode", "2024-01-01", "https://flask.palletsprojects.com/stable/quickstart/#debug-mode")
_C_CWE918  = _cite("CWE-918", "Server-Side Request Forgery (SSRF)", "2024-02-29", "https://cwe.mitre.org/data/definitions/918.html")
_C_REQUESTS = _cite("PYTHON-REQUESTS", "Requests library - user-controlled URLs", "2024-01-01", "https://requests.readthedocs.io/")
